    ...
    f: {
      ...
      clean: (o) => {
        ...
        if (o.str) {
          ...
          r = new DOMParser().parseFromString(o.str, "text/html")
      ...
      scale: (o) => {
        ...
        $.s.backdrop.style.height = Math.floor(o.fit.h) + "px";
        $.s.backdrop.style.width = Math.floor(o.fit.w) + "px";
      ...
      detect: {
        ...
        reduce: (o) => {
          ...
          */
          $.v.detect.swatchSize = Math.max(
            Math.min(
              Math.floor(canvas.width / $.a.detect.swatchLimit),
              Math.floor(canvas.height / $.a.detect.swatchLimit)
            ),
            $.a.detect.swatchMin
          );
          ...
          for (r = 0; r < $.v.detect.sample.length; r = r + 1) {
            for (c = 0; c < $.v.detect.sample[0].length; c = c + 1) {
              ...
              if (!$.v.detect.sample[r][c].isBg) {
                if (
                  $.v.detect.sample[r][c].hsv.h === bgHsv.h &&
                  $.v.detect.sample[r][c].hsv.v === bgHsv.v
                ) {
                  $.v.detect.sample[r][c].isBg = true;
                }
              }
              ...
              if (!$.v.detect.sample[r][c].isBg) {
                ...
                for (i = 0; i < 8; i = i + 1) {
                  ...
                  if (
                    tr > -1 &&
                    tc > -1 &&
                    tr < $.v.detect.sample.length &&
                    $.v.detect.sample[0].length
                  ) {
        ...
        select: (o) => {
          ...
          whatResult = () => {
            ...
            minSelectSize =
              ($.a.select.handleLength / $.v.detect.swatchSize) * 2;
            ...
            if (
              ...
              $.v.select.x =
                areaFound[0].c * $.v.detect.swatchSize + $.a.select.handlePad;
              $.v.select.y =
                areaFound[0].r * $.v.detect.swatchSize + $.a.select.handlePad;
              $.v.select.h =
                areaFound[0].h * $.v.detect.swatchSize -
                $.a.select.handlePad * 2;
              $.v.select.w =
                areaFound[0].w * $.v.detect.swatchSize -
                $.a.select.handlePad * 2;
      ...
      cmd: {
        ...
        visit: (o) => {
          ...
          $.w.open(
            "https://www.pinterest.com/pin/" + $.f.get({ el: o, att: "pinId" }),
            "_blank"
          );
        }
      },
      ...
      act: {
        ...
        showResults: (r) => {
          ...
          for (i = 0; i < $.v.columnCount; i = i + 1) {
            $.d.getElementById("c_" + i).textContent = "";
          }
          ...
          if (r.data.data && r.data.data.length) {
            ...
            for (i = 0; i < r.data.data.length; i = i + 1) {
              ...
              searchButton = thumb.appendChild(
                $.f.make({
                  SPAN: {
        ...
        query: () => {
          ...
          if ($.v.query.data.img) {
            ...
            downImg.onload = () => {
              if (
                downImg.naturalHeight > $.a.searchResolution ||
                downImg.naturalWidth > $.a.searchResolution
              ) {
                ...
                downImgCanvasContext.drawImage(
                  downImg,
                  0,
                  0,
                  $.a.searchResolution,
      ...
      select: () => {
        ...
        $.v.ctx.lineTo(
          $.v.select.x + $.v.select.w,
          $.v.select.y + $.v.select.h
        );
        ...
        if ($.v.select.w < $.a.select.handleLength * 2) {
          ...
          $.v.ctx.setLineDash([
            $.a.select.handleLength,
            $.v.select.w - $.a.select.handleLength * 2
          ]);
        }
        // draw it
        $.v.ctx.stroke();
        ...
        $.v.ctx.setLineDash([
          $.a.select.handleLength,
          $.v.select.y + $.v.select.h - $.a.select.handleLength * 2
        ]);
        // right side
        ...
        if ($.v.select.h < $.a.select.handleLength * 2) {
          ...
          $.v.ctx.setLineDash([
            $.a.select.handleLength,
            $.v.select.h - $.a.select.handleLength * 2
          ]);
        }
        // draw it
        $.v.ctx.stroke();
          ...
          case "down":
            if (overEl === $.s.canvas) {
              ...
              if (typeof $.v.selectedDot === "number") {
                $.v.select.x =
                  $.v.detect.areaFound[$.v.selectedDot].c *
                  $.v.detect.swatchSize;
                $.v.select.y =
                  $.v.detect.areaFound[$.v.selectedDot].r *
                  $.v.detect.swatchSize;
                $.v.select.h =
                  $.v.detect.areaFound[$.v.selectedDot].h *
                  $.v.detect.swatchSize;
                $.v.select.w =
                  $.v.detect.areaFound[$.v.selectedDot].w *
                  $.v.detect.swatchSize;
                // log the click
                $.f.log({
                  event: "click",
                ...
                if (overEl === $.s.canvas) {
                  ...
                  if ($.v.detect.dotCoords) {
                    for (i = 0; i < $.v.detect.dotCoords.length; i++) {
                      if (
                        o.e.clientX <
                        $.v.detect.dotCoords[i][0] + rect.left + 10
                      ) {
                        if (
                          o.e.clientX >
                          $.v.detect.dotCoords[i][0] + rect.left - 10
                          ...
                          if (
                            o.e.clientY <
                            $.v.detect.dotCoords[i][1] + rect.top + 10
                          ) {
                            if (
                              o.e.clientY >
                              $.v.detect.dotCoords[i][1] + rect.top - 10
                    ...
                    if ($.v.canvasX < $.v.select.x + $.v.select.w) {
                      if ($.v.canvasY > $.v.select.y) {
                        if ($.v.canvasY < $.v.select.y + $.v.select.h) {
                          ...
                          if (
                            $.v.canvasX <
                            $.v.select.x + $.a.select.handleLength
                          ) {
                            // see if we're over the northwest handle
                            if (
                              $.v.canvasY <
                              $.v.select.y + $.a.select.handleLength
                            ) {
                              $.f.changeClass({
                                el: $.s.canvas,
                                add: [$.a.k + "_nw"]
      ...
      load: (o) => {
        ...
        img.onload = () => {
          callback = () => {
            ...
            $.v.columnCount = Math.floor(
              ($.w.innerWidth - gridLeft) / $.a.thumbWidth
            );
            if (!$.v.columnCount) {
              $.v.columnCount = 1;
            }
            ...
            $.s.bd.style.width =
              $.v.select.limitX + 40 + $.v.columnCount * $.a.thumbWidth + "px";
            for (i = 0; i < $.v.columnCount; i = i + 1) {
